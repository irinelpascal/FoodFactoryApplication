package com.softvision.foodfactory.base.service.oven;
...
public interface OvenService {
    ...
    /**
     * This returns the size of the oven in square meters. As a simplification of the problem, assume that the
